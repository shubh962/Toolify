import { Zap, ShieldCheck, Speedometer, Combine, FileText } from 'lucide-react';
import Link from 'next/link';
import { Metadata } from 'next';
import { Card } from '@/components/ui/card'; // UI components assume to be available

export const metadata: Metadata = {
  title: 'The Ultimate TaskGuru Toolkit: 5 AI-Powered Tools to Supercharge Your Daily Productivity',
  description: "Discover 5 free AI tools from TaskGuru (Image to Text, Paraphraser, PDF Merger, etc.) that simplify complex tasks, enhance productivity, and save you time.",
  keywords: [
  ...
  robots: 'index, follow',
  alternates: {
    canonical: 'https://taskguru.online/blog/The Ultimate TaskGuru Toolkit: 5 AI-Powered Tools to Supercharge Your Daily Productivity ', // Replace with dynamic slug
  },
};
    ...
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <header className="text-center space-y-4">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white leading-tight">
          The Ultimate TaskGuru Toolkit: 5 AI-Powered Tools to Supercharge Your Daily Productivity
        </h1>
      ...
      <div className="space-y-10 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <Card className="p-6">
          ...
          <ul className="list-disc list-inside mt-4 space-y-2">
            ...
            <li>**Why You Need It:** It’s indispensable for digitizing old notes, extracting data from receipts, or copying code snippets from screenshots.</li>
          </ul>
