...
// ✅ FIX 1: Removed "Toolify", added openGraph
export const metadata: Metadata = {
  title: "Official Disclaimer | TaskGuru Transparency & Liability",
  description:
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-20 text-gray-800 dark:text-gray-200 leading-relaxed font-sans">
      ...
      <div className="space-y-12 text-lg">
        ...
        {/* ✅ FIX 3: Removed "Toolify" from intro */}
        <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-3xl border-l-8 border-red-600 shadow-sm">
          <p className="italic font-medium leading-relaxed">
            <strong>Transparency at TaskGuru:</strong> My name is <strong>Shubham Gautam</strong>, and I built TaskGuru to provide a safe, free, and efficient digital workspace. However, every technology has its boundaries. This disclaimer is my commitment to being 100% honest with you about what our tools can and cannot do.
          </p>
        </div>
        ...
        <section className="border-b pb-10 dark:border-gray-800">
          ...
          <p className="mb-6 leading-relaxed">
            As detailed in our{" "}
            <strong><Link href="/privacy-policy" className="underline font-bold text-green-600">Privacy Policy</Link></strong>,
            TaskGuru processes files in volatile memory (RAM). We do not create permanent logs or backups of your sensitive documents.
          </p>
      ...
      {/* ✅ FIX 4: Removed "Toolify", dynamic year */}
      <footer className="mt-20 text-center text-sm text-gray-400 italic border-t pt-10">
        <p>TaskGuru is a human-first project by Shubham Gautam.</p>
        <p className="mt-1">By continuing to use this site, you agree to these legal boundaries.</p>
        <p className="mt-1 not-italic font-bold">© {new Date().getFullYear()} TaskGuru — All Rights Reserved</p>
