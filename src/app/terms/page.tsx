...
export default function TermsPage() {
  return (
    <main className="p-6 max-w-4xl mx-auto py-12 min-h-screen">
      ...
      <p className="mb-4 text-gray-700 dark:text-gray-300 leading-relaxed">
        हमारी सेवाएँ "जैसी हैं" (**AS IS**) और "जैसी उपलब्ध हैं" (**AS AVAILABLE**) के आधार पर प्रदान की जाती हैं। Toolify किसी भी प्रकार की वारंटी (warranty) की गारंटी नहीं देता कि सेवाएँ अबाधित, सुरक्षित, या त्रुटि-मुक्त होंगी।
      </p>
