    ...
    <main className="p-6 max-w-4xl mx-auto py-16">
      ...
      <section className="mt-10">
        <h2 className="text-3xl font-bold mb-8 text-center text-foreground flex items-center justify-center gap-3">
          <UserCheck className="w-6 h-6 text-primary" /> The Expertise Behind TaskGuru
        </h2>
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-indigo-200 dark:border-indigo-700">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            TaskGuru is a passion project led by Shubham Gautam, a professional with **[MENTION YOUR FIELD/YEARS OF EXPERIENCE - e.g., extensive 5+ years of experience in full-stack development and data science]**. This background ensures that every tool on TaskGuru is developed not just with speed in mind, but also with a focus on **data accuracy, security, and enterprise-level reliability**. We don't just use AI; we understand how to integrate it safely and effectively.
          </p>
      ...
      {/* Why Choose Us - Detailed H2/H3 Section (Existing Content) */}
      <section className="mt-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-4 border rounded-lg shadow-md hover:shadow-xl transition duration-300">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-400 space-y-1">
              <li>**Zero File Storage:** All uploaded files are deleted immediately after processing is complete.</li>
              <li>No mandatory sign-ups, keeping your usage anonymous and private.</li>
              <li>Clear <Link href="/privacy-policy" className="text-primary underline font-medium">Privacy Policy</Link> and <Link href="/terms" className="text-primary underline font-medium">Terms of Service</Link> available for transparency.</li>
            </ul>
          </div>
        </div>
      </section>

      {/* Call to Action (Existing Content) */}
