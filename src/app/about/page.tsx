  ...
  return (
    <main className="p-6 max-w-5xl mx-auto py-20 font-sans leading-relaxed text-gray-800 dark:text-gray-200">
        ...
        <div className="md:col-span-1">
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-1 rounded-3xl shadow-2xl transition-transform hover:scale-105">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl text-center">
                ...
                {/* PHOTO CONTAINER - Build Error Fixed */}
                <div className="w-32 h-32 mx-auto mb-4 relative overflow-hidden rounded-full border-4 border-indigo-100 dark:border-indigo-900 bg-indigo-50 dark:bg-gray-800 flex items-center justify-center">
                    {/* Placeholder SG will show if image is missing */}
                ...
                <div className="mt-4 flex justify-center gap-2 text-[10px] font-bold uppercase">
                    <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-950 rounded-full tracking-wider border border-indigo-100 dark:border-indigo-900">Next.js Expert</span>
                    <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-950 rounded-full tracking-wider border border-indigo-100 dark:border-indigo-900">AI Architect</span>
                </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-24 text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800 dark:text-gray-100">Our Quality Standards</h2>
        ...
        <div className="bg-gray-50 dark:bg-gray-900 p-10 rounded-3xl border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex flex-wrap justify-around gap-10">
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Email Support</span>
                    <span className="text-lg font-medium">GautamShubham962@Gmail.Com</span>
                </div>
                <div className="flex flex-col items-center">
                    <div className="w-12 h-12 bg-white dark:bg-gray-800 shadow-md rounded-full flex items-center justify-center mb-3 text-indigo-600">
                        <MapPin />
                    </div>
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Base Location</span>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Established</span>
                    <span className="text-lg font-medium">January 2024</span>
                </div>
            </div>
