...
export default function SplitPdf() {
  ...
  // ✅ FIX 6: Revoke blob URLs on reset to prevent memory leak
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl border p-8 md:p-12 text-center space-y-8 mb-20">
        ...
        {/* ✅ FIX 1: h1 → h2 — page.tsx owns the h1 */}
      ...
      {/* SEO ARTICLE */}
      {/* ✅ FIX 2: Removed prose classes — plain Tailwind */}
      <article className="space-y-12 border-t pt-16 text-slate-600 dark:text-slate-400">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            portals with size limits. Using the <strong>TaskGuru Split PDF</strong>{" "}
            tool allows you to:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              <strong>Organize Invoices:</strong> Separate a bulk scan of receipts
              into individual files for accounting.
            </li>
          </ul>
        </section>
        ...
        <section className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-3xl border border-blue-100 dark:border-blue-800">
          ...
          <p>
            Made a mistake and split too many pages? Put them back together using
            our{" "}
            {/* ✅ FIX 4: <a> → <Link> */}
            <Link
