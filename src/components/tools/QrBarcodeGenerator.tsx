...
// ✅ FIX 2: Sanitize filename — prevents slashes/special chars breaking download
  ...
  const handleDownload = (type: 'qr' | 'bar') => {
    ...
    if (type === 'qr') {
      ...
      if (svg) {
        ...
        // ✅ encodeURIComponent handles unicode chars in SVG
              ...
              <CardContent className="p-8 space-y-8">
                ...
                <div className="border-t pt-8 space-y-6">
                  <h3 className="font-semibold flex items-center gap-2 text-lg">
                    <Settings2 className="w-5 h-5 text-primary" /> Customization
                  </h3>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        <Input
                          ...
                          className="h-12 w-20 cursor-pointer p-1 rounded-md border-2"
                        />
                        <span className="text-sm font-mono text-muted-foreground">{qrFgColor}</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      {/* ✅ FIX 3: Clarified size slider purpose */}
                      <Label>
                        Size ({qrSize}px)
                        <span className="ml-2 text-xs text-muted-foreground font-normal">
                          — higher = better print quality
                        </span>
                      </Label>
                      <Slider
                        value={[qrSize]}
          ...
          <div className="md:col-span-5">
            <Card className="bg-slate-900 text-white border-none shadow-2xl flex flex-col items-center justify-center p-12 space-y-10 min-h-[450px] relative overflow-hidden">
              ...
              <Button
                ...
                size="lg"
                className="w-full max-w-xs h-14 text-lg font-bold bg-green-500 hover:bg-green-600 shadow-lg shadow-green-500/20 z-10"
              >
              ...
              <CardContent className="p-8 space-y-8">
                <div className="space-y-4">
                  ...
                  <Input
                    ...
                    className="h-14 text-lg font-mono bg-muted/20"
                  />
                </div>
                <div className="space-y-4">
                ...
                <div className="border-t pt-8 space-y-6">
                  <h3 className="font-semibold flex items-center gap-2 text-lg">
                    <Palette className="w-5 h-5 text-indigo-500" /> Styles
                  </h3>
      ...
      <article className="space-y-16 border-t pt-16 text-slate-700 dark:text-slate-300">
        ...
        <section className="text-center max-w-3xl mx-auto space-y-4">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white">
            Why Use TaskGuru&apos;s Generator?
          </h2>
          <p className="text-lg leading-relaxed">
            Whether you are a business owner, event organizer, or just sharing a WiFi password,
            our <strong>2-in-1 Generator</strong> provides the most reliable, high-resolution
            codes on the web. No sign-ups, no watermarks — just pure utility.
          </p>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-blue-50 dark:bg-blue-900/10 p-8 rounded-3xl border border-blue-100 dark:border-blue-800">
            ...
            <p className="leading-relaxed">
              Unlike other generators that track your data or redirect links through their servers,
              TaskGuru generates codes <strong>directly in your browser</strong>. Your URLs, text,
              and inventory data never leave your device.
            </p>
          </div>
          <div className="bg-green-50 dark:bg-green-900/10 p-8 rounded-3xl border border-green-100 dark:border-green-800">
            ...
            <p className="leading-relaxed">
              Download your codes as high-resolution PNG files — perfect for printing on large
              banners, product packaging, or business cards without any pixelation.
            </p>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto pt-10 border-t border-muted">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <ToolCard
            ...
            desc="Optimize your QR code images for faster website loading."
          ...
          <ToolCard
            ...
            desc="Create transparent logos to embed inside your QR codes."
          ...
          <ToolCard
            ...
            title="Image to Text"
            desc="Extract text or links from existing static QR code images."
