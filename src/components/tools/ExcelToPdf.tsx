...
const toolSchema = {
  ...
  url: 'https://www.taskguru.site/tools/excel-to-pdf',
...
export default function ExcelToPdf() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      pages.forEach((p, i) => {
        p.drawText(`Generated by taskguru.site • ${convertAllSheets ? 'All Sheets' : `Sheet: ${sheets[selectedSheet].name}`} • Page ${i + 1} of ${pages.length}`, {
