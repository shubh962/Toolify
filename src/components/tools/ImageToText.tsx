...
import Head from "next/head"; // ✅ SEO ke liye sahi import
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="image to text, free OCR tool, extract text from images, convert image to text, TaskGuru, online OCR, text recognition"
        />
