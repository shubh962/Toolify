...
export const metadata: Metadata = {
  title: 'Free Image Background Remover Online | TaskGuru',
  description:
    "Remove image backgrounds instantly with TaskGuru's free AI background remover tool. Upload JPG, PNG, WEBP and download transparent background images in seconds.",
  keywords: [
  ...
  openGraph: {
    title: 'Free Background Remover Tool Online | TaskGuru',
    description:
      'Remove image backgrounds instantly with TaskGuru’s AI-powered background remover. 100% free – supports JPG, PNG & WEBP.',
  ...
  twitter: {
    ...
    description:
      'Erase backgrounds from images instantly using TaskGuru’s free AI tool. Upload PNG, JPG, WEBP & download transparent images.',
